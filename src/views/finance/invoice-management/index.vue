...
<script setup lang="tsx">
  ...
  type SearchParams = Api.Finance.InvoiceSearchParams
  ...
  async function handleStatusAction(row: Invoice, statusAction: Api.Finance.InvoiceStatusAction) {
  ...
  async function handleRemarkAction(
    row: Invoice,
    statusAction: Extract<Api.Finance.InvoiceStatusAction, 'reject' | 'void'>
  ) {
