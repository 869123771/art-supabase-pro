...
<script setup lang="ts">
  ...
  import { analyzeInvoiceComplianceByAi } from '@/api/finance'
  import { formatWithDayjs } from '@/utils/time'
  import { formatCurrencyValue } from '@/utils/ui'

  defineOptions({ name: 'FinanceInvoiceComplianceAuditDrawer' })

  type AuditResponse = Api.Finance.InvoiceComplianceAuditResponse
  type Assessment = Api.Finance.InvoiceComplianceAssessment
  type RiskLevel = Api.Finance.InvoiceComplianceRiskLevel
  type Recommendation = Api.Finance.InvoiceComplianceRecommendation
  type SignalSeverity = Api.Finance.InvoiceComplianceSeverity
