...
<script setup lang="ts">
  ...
  type CounterpartyResolutionStatus =
    Api.Finance.InvoiceCounterpartyResolutionStatus | 'idle' | 'loading' | 'error'
  ...
  interface CounterpartyResolutionGroup {
    ...
    message: string
    artifactId?: string
    result?: Api.Finance.InvoiceCounterpartyResolution | null
  }

  interface InvoiceOcrContext {
    direction: Api.Finance.InvoiceDirection
    result: Api.Finance.InvoiceOcrAnalyzeResponse
  }
  ...
  const duplicateInvoice = ref<Api.Finance.InvoiceDuplicateRecord>()
  const ocrSourceDuplicateInvoice = ref<Api.Finance.InvoiceDuplicateRecord>()
  ...
  async function checkDuplicateInvoice(): Promise<Api.Finance.InvoiceDuplicateRecord | undefined> {
  ...
  function applyCounterparty(party: Api.Finance.InvoiceCounterpartyOption): void {
  ...
  function handleCounterpartyCreated(
    result: Api.Finance.CreateInvoiceCounterpartyFromOcrResponse
  ): void {
    ...
    Object.assign(counterpartyResolution, {
      ...
      result: {
        ...(counterpartyResolution.result as Api.Finance.InvoiceCounterpartyResolution),
        status: 'matched',
        canCreate: false,
