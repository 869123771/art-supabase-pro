...
<script setup lang="ts">
  ...
  import { analyzeInvoiceAttachmentByAi } from '@/api/finance'
  ...
  const emit = defineEmits<{
    ...
    apply: [result: Api.Finance.InvoiceOcrAnalyzeResponse]
  }>()

  type OcrResponse = Api.Finance.InvoiceOcrAnalyzeResponse
  type OcrField = Api.Finance.InvoiceOcrField
