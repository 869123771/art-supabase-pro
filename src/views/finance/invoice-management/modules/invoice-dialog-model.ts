...
export type Invoice = Api.Finance.InvoiceRecord
...
export interface InvoiceFormModel {
  ...
  invoiceType: Api.Finance.InvoiceType
  invoiceTitle: string
  taxNumber: string
  invoiceCode: string
  invoiceNo: string
...
interface BuildInvoicePayloadOptions {
  ...
  duplicate?: Api.Finance.InvoiceDuplicateRecord
...
export function buildInvoicePayload({
  ...
  duplicate,
  mergeDuplicate
}: BuildInvoicePayloadOptions): Api.Finance.SaveInvoicePayload {
  return {
