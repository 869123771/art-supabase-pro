...
<script setup lang="ts">
  ...
  import { createInvoiceCounterpartyFromOcr } from '@/api/finance'
  import { useUserStore } from '@/store/modules/user'

  defineOptions({ name: 'FinanceInvoiceCounterpartyCreateDialog' })
  ...
  const emit = defineEmits<{
    success: [result: Api.Finance.CreateInvoiceCounterpartyFromOcrResponse]
  }>()
