...
<script setup lang="ts">
  ...
  import { analyzeReceivablesCollectionByAi } from '@/api/finance'
  import { financeRouteNames } from '@/router/business-paths'
  import { formatWithDayjs } from '@/utils/time'

  defineOptions({ name: 'FinanceReceivablesCollectionAdvisorDrawer' })

  type AnalysisResponse = Api.Finance.ReceivablesCollectionResponse
  type RiskLevel = Api.Finance.ReceivablesRiskLevel
  type Recommendation = Api.Finance.ReceivablesRecommendation
  type Severity = Api.Finance.ReceivablesSignalSeverity
  type PriorityStatement = Api.Finance.ReceivablesPriorityStatement
