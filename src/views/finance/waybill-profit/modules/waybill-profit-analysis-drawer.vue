...
<script setup lang="ts">
  ...
  import { analyzeWaybillProfitByAi } from '@/api/finance'
  import { formatWithDayjs } from '@/utils/time'

  defineOptions({ name: 'FinanceWaybillProfitAnalysisDrawer' })

  type AnalysisResponse = Api.Finance.WaybillProfitAnalysisResponse
  type RiskLevel = Api.Finance.WaybillProfitAnalysisRiskLevel
  type Recommendation = Api.Finance.WaybillProfitAnalysisRecommendation
  type Severity = Api.Finance.WaybillProfitAnalysisSeverity
