...
<script setup lang="ts">
  ...
  import { analyzeWaybillCostByAi } from '@/api/finance'
  import { formatWithDayjs } from '@/utils/time'

  defineOptions({ name: 'FinanceWaybillCostAuditDrawer' })

  type AuditResponse = Api.Finance.WaybillCostAuditResponse
  type RiskLevel = Api.Finance.WaybillCostAuditRiskLevel
  type Recommendation = Api.Finance.WaybillCostAuditRecommendation
  type SignalSeverity = Api.Finance.WaybillCostAuditSeverity
