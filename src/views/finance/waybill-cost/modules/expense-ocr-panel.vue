...
<script setup lang="ts">
  ...
  import { analyzeWaybillExpenseByAi } from '@/api/finance'
  ...
  const emit = defineEmits<{
    ...
    apply: [result: Api.Finance.WaybillExpenseOcrAnalyzeResponse]
    failed: []
  }>()
  ...
  const state = reactive<{
    analyzing: boolean
    result?: Api.Finance.WaybillExpenseOcrAnalyzeResponse
