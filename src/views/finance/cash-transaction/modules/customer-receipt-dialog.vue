...
<script setup lang="tsx">
  ...
  const ocrResult = ref<Api.Finance.CashVoucherOcrAnalyzeResponse>()
  ...
  function handleApplyOcrResult(result: Api.Finance.CashVoucherOcrAnalyzeResponse): void {
  ...
  function applyRecommendedStatements(
    matches: Api.Finance.CashVoucherStatementMatch[],
    customerId: string
  ): void {
  ...
  async function handleOpenFromOcr(
    result: Api.Finance.CashVoucherOcrAnalyzeResponse
  ): Promise<void> {
    await handleOpen()
