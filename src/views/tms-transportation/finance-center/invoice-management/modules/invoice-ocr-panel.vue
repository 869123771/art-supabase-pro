...
<script setup lang="ts">
  ...
  const emit = defineEmits<{
    ...
    apply: [result: Api.Tms.Finance.InvoiceOcrAnalyzeResponse]
  }>()

  type OcrResponse = Api.Tms.Finance.InvoiceOcrAnalyzeResponse
  type OcrField = Api.Tms.Finance.InvoiceOcrField
