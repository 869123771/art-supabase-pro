...
<script setup lang="tsx">
  ...
  import { analyzeBankStatementBatchByAi, commitBankStatementBatchByAi } from '@/api/tms'
  import { useUserStore } from '@/store/modules/user'
  import { useArtFeedback } from '@/hooks/core/useArtFeedback'

  defineOptions({ name: 'TmsCashBankBatchImportDialog' })
  type Row = Api.Tms.Finance.BankBatchMatchRow
  type Status = Api.Tms.Finance.BankBatchRowStatus
  ...
  const state = reactive<{
    ...
    error: Error | null
    fileName: string
    result?: Api.Tms.Finance.BankBatchAnalyzeResponse
  }>({
    analyzing: false,
    committing: false,
    error: null,
