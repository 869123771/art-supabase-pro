...
<script setup lang="tsx">
  ...
  import { fetchWaybillExpenseOcrRunList } from '@/api/tms'
  import { pageInfoHandler } from '@/utils/table/tableUtils'
  import { formatWithDayjs } from '@/utils/time'
  import { useUserStore } from '@/store/modules/user'

  defineOptions({ name: 'TmsWaybillExpenseOcrLogDrawer' })

  type OcrRun = Api.Tms.Finance.WaybillExpenseOcrRunRecord
  type SearchParams = Api.Tms.Finance.WaybillExpenseOcrRunSearchParams
