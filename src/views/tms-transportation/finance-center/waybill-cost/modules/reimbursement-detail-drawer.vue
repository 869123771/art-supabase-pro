...
<script setup lang="tsx">
  ...
  defineOptions({ name: 'TmsWaybillExpenseReimbursementDetailDrawer' })
  ...
  const columns: ColumnOption<Item>[] = [
    { prop: 'costNoSnapshot', label: '费用单号', width: 190 },
    ...
    },
    {
      ...
      label: '发生日期',
      width: 120,
      formatter: (row) => formatWithDayjs(row.occurredOnSnapshot, 'YYYY-MM-DD')
    },
    {
      prop: 'amountSnapshot',
      label: '核销金额',
