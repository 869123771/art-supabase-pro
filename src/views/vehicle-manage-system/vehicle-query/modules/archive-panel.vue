...
<script setup lang="ts">
  ...
  const otherItems = computed<InfoItem[]>(() => [
    ...
    { label: '驾驶员一名称', value: props.vehicle.driverOneName },
    { label: '驾驶员一电话', value: props.vehicle.driverOnePhone },
    { label: '驾驶员二名称', value: props.vehicle.driverTwoName },
    { label: '驾驶员二电话', value: props.vehicle.driverTwoPhone },
