...
<script setup lang="ts">
  ...
  import { analyzeVehicleHealthByAi } from '@/api/vehicle-manage-system'
  import { formatWithDayjs } from '@/utils/time'

  defineOptions({ name: 'VehicleHealthAdvisorDrawer' })

  type AdvisorResponse = Api.VehicleMgtSys.VehicleManage.VehicleHealthAdvisorResponse
  type Assessment = Api.VehicleMgtSys.VehicleManage.VehicleHealthAssessment
  type RiskLevel = Api.VehicleMgtSys.VehicleManage.VehicleHealthRiskLevel
  type Severity = Api.VehicleMgtSys.VehicleManage.VehicleHealthSeverity
