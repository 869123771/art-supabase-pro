...
<script setup lang="ts">
  ...
  import { analyzeInvoiceComplianceByAi } from '@/api/fms'
  import { formatWithDayjs } from '@/utils/time'
  import { formatCurrencyValue } from '@/utils/ui'

  defineOptions({ name: 'FinanceInvoiceComplianceAuditDrawer' })

  type AuditResponse = Api.Fms.InvoiceComplianceAuditResponse
  type Assessment = Api.Fms.InvoiceComplianceAssessment
  type RiskLevel = Api.Fms.InvoiceComplianceRiskLevel
  type Recommendation = Api.Fms.InvoiceComplianceRecommendation
  type SignalSeverity = Api.Fms.InvoiceComplianceSeverity
