...
<script setup lang="ts">
  ...
  import { analyzeWaybillCostByAi } from '@/api/fms'
  import { formatWithDayjs } from '@/utils/time'

  defineOptions({ name: 'FinanceWaybillCostAuditDrawer' })

  type AuditResponse = Api.Fms.WaybillCostAuditResponse
  type RiskLevel = Api.Fms.WaybillCostAuditRiskLevel
  type Recommendation = Api.Fms.WaybillCostAuditRecommendation
  type SignalSeverity = Api.Fms.WaybillCostAuditSeverity
