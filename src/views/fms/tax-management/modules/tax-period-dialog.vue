...
<script setup lang="ts">
  ...
  import { fetchAccountingPeriodList, fetchAccountSetOptions, saveTaxPeriod } from '@/api/fms'
  ...
  async function submit() {
    try {
      ...
      await saveTaxPeriod({
        ...
        transferableInputAmount: form.transferableInputAmount,
  ...
  async function handleOpen(row?: Api.Fms.TaxPeriodRecord) {
    ...
    Object.assign(form, {
      ...
      transferableInputAmount: row?.transferableInputAmount || 0,
