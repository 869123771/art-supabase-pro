...
type PaymentApplication = Api.Finance.CarrierPaymentApplicationRecord
type PaymentApplicationItem = Api.Finance.CarrierPaymentApplicationItem
type SearchParams = Api.Finance.CarrierPaymentApplicationSearchParams
type SavePayload = Api.Finance.SaveCarrierPaymentApplicationPayload
type ExecutePayload = Api.Finance.ExecuteCarrierPaymentApplicationPayload
