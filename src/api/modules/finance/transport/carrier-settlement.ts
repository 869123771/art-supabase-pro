...
type Statement = Api.Finance.CarrierStatementRecord
type StatementItem = Api.Finance.CarrierStatementItem
type SearchParams = Api.Finance.CarrierStatementSearchParams
type EligibleCost = Api.Finance.CarrierStatementEligibleCost
type EligibleSearchParams = Api.Finance.CarrierStatementEligibleCostSearchParams
type CreatePayload = Api.Finance.CreateCarrierStatementPayload
type StatusPayload = Api.Finance.CarrierStatementStatusPayload & { businessTitle?: string }
