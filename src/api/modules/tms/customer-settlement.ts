...
type CustomerStatementSearchParams = Api.Tms.Finance.CustomerStatementSearchParams
type EligibleWaybill = Api.Tms.Finance.CustomerStatementEligibleWaybill
type EligibleWaybillSearchParams = Api.Tms.Finance.CustomerStatementEligibleWaybillSearchParams
type CreateCustomerStatementPayload = Api.Tms.Finance.CreateCustomerStatementPayload
type CustomerStatementStatusPayload = Api.Tms.Finance.CustomerStatementStatusPayload
