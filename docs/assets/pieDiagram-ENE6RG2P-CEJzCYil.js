import{t as e}from"./ordinal-DtR4qwUh.js";import{t}from"./arc-A67ek8Xt.js";import{t as n}from"./pie-BSK8fJ_8.js";import{i as r,p as i}from"./chunk-ICXQ74PX-BVEx936V.js";import{n as a}from"./chunk-Y2CYZVJY-DsF7k-Jl.js";import{t as o}from"./src-Bh5zVVju.js";import{H as s,K as c,U as l,a as u,c as d,f,v as p,w as m,x as h,y as g}from"./chunk-WYO6CB5R-f0zCp2u3.js";import{t as _}from"./chunk-VAUOI2AC-DH5X-Nxq.js";import{t as v}from"./chunk-JWPE2WC7-DVXcaiue.js";import{n as y}from"./mermaid-parser.core-PT6tbr1j.js";var b=f.pie,x={sections:new Map,showData:!1,config:b},S=x.sections,C=x.showData,w=structuredClone(b),T={getConfig:a(()=>structuredClone(w),`getConfig`),clear:a(()=>{S=new Map,C=x.showData,u()},`clear`),setDiagramTitle:c,getDiagramTitle:m,setAccTitle:l,getAccTitle:g,setAccDescription:s,getAccDescription:p,addSection:a(({label:e,value:t})=>{if(t<0)throw Error(`"${e}" has invalid value: ${t}. Negative values are not allowed in pie charts. All slice values must be >= 0.`);S.has(e)||(S.set(e,t),o.debug(`added new section: ${e}, with value: ${t}`))},`addSection`),getSections:a(()=>S,`getSections`),setShowData:a(e=>{C=e},`setShowData`),getShowData:a(()=>C,`getShowData`)},E=a((e,t)=>{v(e,t),t.setShowData(e.showData),e.sections.map(t.addSection)},`populateDb`),D={parse:a(async e=>{let t=await y(`pie`,e);o.debug(t),E(t,T)},`parse`)},O=a(e=>`
  .pieCircle{
