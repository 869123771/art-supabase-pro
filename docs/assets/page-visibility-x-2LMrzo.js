...
}`)],-1),n(`p`,null,[n(`strong`,null,`权限验证流程：`)],-1),n(`ul`,null,[n(`li`,null,`用户登录成功后获取 Token`),n(`li`,null,`前端调用菜单接口获取用户可访问的菜单列表`),n(`li`,null,`前端根据菜单列表动态注册路由`),n(`li`,null,`菜单中存在的页面用户可以正常访问，不存在的页面会跳转到 404`)],-1)])]),_:1})]),_:1}),i(W,{timestamp:`菜单显示控制`,type:`success`,size:`large`},{default:s(()=>[i(S,null,{default:s(()=>[...r[11]||(r[11]=[n(`h4`,null,`侧边栏菜单可见性`,-1),n(`p`,null,[n(`strong`,null,`前端控制模式：`)],-1),n(`ul`,null,[n(`li`,null,`有权限的用户：菜单项正常显示，可以点击访问`),n(`li`,null,`无权限的用户：菜单项不显示，无法通过菜单导航到页面`),n(`li`,null,`即使通过直接输入URL尝试访问，也会被路由守卫拦截`)],-1),n(`p`,null,[n(`strong`,null,`后端控制模式：`)],-1),n(`ul`,null,[n(`li`,null,`侧边栏菜单根据后端返回的菜单列表进行渲染`),n(`li`,null,`后端应该根据用户权限过滤，只返回用户有权限访问的菜单项`),n(`li`,null,`前端只显示后端返回的菜单，确保用户只能看到和访问有权限的页面`)],-1)])]),_:1})]),_:1})]),_:1})])]),_:1})]),n(`div`,P,[i(S,{class:`art-card-xs`},{header:s(()=>[...r[12]||(r[12]=[n(`div`,{class:`card-header`},[n(`span`,null,`权限控制最佳实践`)],-1)])]),default:s(()=>[n(`div`,F,[i(Z,{gutter:24},{default:s(()=>[i(X,{span:12,class:`!mb-5`},{default:s(()=>[n(`div`,I,[n(`div`,L,[i(Y,{size:`20`,color:`#409EFF`},{default:s(()=>[i(c(d))]),_:1})]),r[13]||(r[13]=n(`div`,null,[n(`h4`,null,`多层权限验证`),n(`p`,{class:`text-g-700 text-sm`},`在前端路由、后端接口、UI组件等多个层面实施权限控制，确保安全性。`)],-1))])]),_:1}),i(X,{span:12},{default:s(()=>[n(`div`,R,[n(`div`,z,[i(Y,{size:`20`,color:`#67C23A`},{default:s(()=>[i(c(y))]),_:1})]),r[14]||(r[14]=n(`div`,null,[n(`h4`,null,`基于角色的访问控制`),n(`p`,{class:`text-g-700 text-sm`},`采用RBAC模型，通过角色分配权限，简化权限管理复杂度。`)],-1))])]),_:1}),i(X,{span:12},{default:s(()=>[n(`div`,B,[n(`div`,V,[i(Y,{size:`20`,color:`#E6A23C`},{default:s(()=>[i(c(p))]),_:1})]),r[15]||(r[15]=n(`div`,null,[n(`h4`,null,`细粒度权限控制`),n(`p`,{class:`text-g-700 text-sm`},`支持页面级、按钮级、数据级等多种粒度的权限控制。`)],-1))])]),_:1}),i(X,{span:12},{default:s(()=>[n(`div`,H,[n(`div`,U,[i(Y,{size:`20`,color:`#F56C6C`},{default:s(()=>[i(c(g))]),_:1})]),r[16]||(r[16]=n(`div`,null,[n(`h4`,null,`安全性优先原则`),n(`p`,{class:`text-g-700 text-sm`},`始终遵循最小权限原则，确保用户只能访问必要的功能和数据。`)],-1))])]),_:1})]),_:1})])]),_:1})])])}}});export{W as default};