import"./rolldown-runtime-DAXXjFlN.js";import{ut as e}from"./common-utils-C_OpVGBL.js";import{t}from"./message-Cfv4BUig.js";/* empty css                            */function n(n,r,i){let a=window.open(``,`_blank`,`width=980,height=760`);if(!a){t.warning(`浏览器阻止了打印窗口，请允许本站打开弹窗后重试`);return}a.opener=null;let o=n.items.map((t,n)=>`<tr><td>${n+1}</td><td>${e(t.materialName)}</td><td>${e(t.specificationModel||`—`)}</td><td>${e(String(t.issueQuantity))}</td><td>${e(i(t.unit))}</td><td>${e(t.remark||``)}</td></tr>`).join(``);a.document.write(`<!doctype html>
<html lang="zh-CN">
<head>
  <meta charset="utf-8">
