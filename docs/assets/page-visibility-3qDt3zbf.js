...
}`)],-1),_(`p`,null,[_(`strong`,null,`权限验证流程：`)],-1),_(`ul`,null,[_(`li`,null,`用户登录成功后获取 Token`),_(`li`,null,`前端调用菜单接口获取用户可访问的菜单列表`),_(`li`,null,`前端根据菜单列表动态注册路由`),_(`li`,null,`菜单中存在的页面用户可以正常访问，不存在的页面会跳转到 404`)],-1)])]),_:1})]),_:1}),d(W,{timestamp:`菜单显示控制`,type:`success`,size:`large`},{default:y(()=>[d(S,null,{default:y(()=>[...v[11]||(v[11]=[_(`h4`,null,`侧边栏菜单可见性`,-1),_(`p`,null,[_(`strong`,null,`前端控制模式：`)],-1),_(`ul`,null,[_(`li`,null,`有权限的用户：菜单项正常显示，可以点击访问`),_(`li`,null,`无权限的用户：菜单项不显示，无法通过菜单导航到页面`),_(`li`,null,`即使通过直接输入URL尝试访问，也会被路由守卫拦截`)],-1),_(`p`,null,[_(`strong`,null,`后端控制模式：`)],-1),_(`ul`,null,[_(`li`,null,`侧边栏菜单根据后端返回的菜单列表进行渲染`),_(`li`,null,`后端应该根据用户权限过滤，只返回用户有权限访问的菜单项`),_(`li`,null,`前端只显示后端返回的菜单，确保用户只能看到和访问有权限的页面`)],-1)])]),_:1})]),_:1})]),_:1})])]),_:1})]),_(`div`,P,[d(S,{class:`art-card-xs`},{header:y(()=>[...v[12]||(v[12]=[_(`div`,{class:`card-header`},[_(`span`,null,`权限控制最佳实践`)],-1)])]),default:y(()=>[_(`div`,F,[d(Z,{gutter:24},{default:y(()=>[d(X,{span:12,class:`!mb-5`},{default:y(()=>[_(`div`,I,[_(`div`,L,[d(Y,{size:`20`,color:`#409EFF`},{default:y(()=>[d(p(t))]),_:1})]),v[13]||(v[13]=_(`div`,null,[_(`h4`,null,`多层权限验证`),_(`p`,{class:`text-g-700 text-sm`},`在前端路由、后端接口、UI组件等多个层面实施权限控制，确保安全性。`)],-1))])]),_:1}),d(X,{span:12},{default:y(()=>[_(`div`,R,[_(`div`,z,[d(Y,{size:`20`,color:`#67C23A`},{default:y(()=>[d(p(a))]),_:1})]),v[14]||(v[14]=_(`div`,null,[_(`h4`,null,`基于角色的访问控制`),_(`p`,{class:`text-g-700 text-sm`},`采用RBAC模型，通过角色分配权限，简化权限管理复杂度。`)],-1))])]),_:1}),d(X,{span:12},{default:y(()=>[_(`div`,B,[_(`div`,V,[d(Y,{size:`20`,color:`#E6A23C`},{default:y(()=>[d(p(r))]),_:1})]),v[15]||(v[15]=_(`div`,null,[_(`h4`,null,`细粒度权限控制`),_(`p`,{class:`text-g-700 text-sm`},`支持页面级、按钮级、数据级等多种粒度的权限控制。`)],-1))])]),_:1}),d(X,{span:12},{default:y(()=>[_(`div`,H,[_(`div`,U,[d(Y,{size:`20`,color:`#F56C6C`},{default:y(()=>[d(p(c))]),_:1})]),v[16]||(v[16]=_(`div`,null,[_(`h4`,null,`安全性优先原则`),_(`p`,{class:`text-g-700 text-sm`},`始终遵循最小权限原则，确保用户只能访问必要的功能和数据。`)],-1))])]),_:1})]),_:1})])]),_:1})])])}}});export{W as default};