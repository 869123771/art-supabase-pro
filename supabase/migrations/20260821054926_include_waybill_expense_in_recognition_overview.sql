...
as $function$
  with visible_reviews as materialized (
    select review.feature, review.status, review.confidence, review.create_time
...
comment on function public.ai_ocr_recognition_overview() is
  'Returns tenant- and owner-scoped OCR recognition metrics for all supported document features.';;
